    ...
    <form onSubmit={onSubmit} className="rounded-2xl border border-zinc-800 bg-zinc-900/50 backdrop-blur-md p-6">
      {fields.map(([name, label, type]) => (
        <label key={name} className="mb-4 block">
          ...
          <input
            className="w-full rounded-xl border border-zinc-800 bg-zinc-900/50 backdrop-blur-md px-4 py-3 outline-none focus:border-zinc-700 focus:ring-2 focus:ring-indigo-100"
            name={name}
      ...
      <label className="block">
        ...
        <textarea
          className="min-h-36 w-full rounded-xl border border-zinc-800 bg-zinc-900/50 backdrop-blur-md px-4 py-3 outline-none focus:border-zinc-700 focus:ring-2 focus:ring-indigo-100"
          name="message"
          required
        />
      </label>
