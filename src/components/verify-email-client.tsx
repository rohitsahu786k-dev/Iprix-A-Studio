    ...
    <div className="mx-auto max-w-md w-full border border-zinc-800 bg-zinc-900/50 backdrop-blur-md rounded-2xl p-8 shadow-sm text-center">
      {status === "loading" && (
        <div className="flex flex-col items-center justify-center space-y-4">
          <Loader2 className="h-10 w-10 text-zinc-100 animate-spin" />
          <h2 className="text-xl font-bold text-zinc-100">Verifying Email</h2>
      ...
      {status === "success" && (
        <div className="flex flex-col items-center justify-center space-y-4">
          <CheckCircle2 className="h-12 w-12 text-zinc-100" />
          <h2 className="text-xl font-bold text-zinc-100">Account Verified!</h2>
          <p className="text-sm text-zinc-400 font-semibold">{message}</p>
        </div>
      )}
      ...
      {status === "error" && (
        <div className="flex flex-col items-center justify-center space-y-4">
          <XCircle className="h-12 w-12 text-zinc-100" />
          <h2 className="text-xl font-bold text-zinc-100">Verification Failed</h2>
  ...
  return (
    <Suspense fallback={
      <div className="mx-auto max-w-md w-full border border-zinc-800 bg-zinc-900/50 backdrop-blur-md rounded-2xl p-8 shadow-sm text-center flex flex-col items-center justify-center space-y-4">
        <Loader2 className="h-10 w-10 text-zinc-100 animate-spin" />
        <h2 className="text-xl font-bold text-zinc-100">Loading</h2>
