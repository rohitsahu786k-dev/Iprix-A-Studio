  ...
  return (
    <PublicShell>
      <section className="container py-20 relative overflow-hidden bg-zinc-950">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#ececef_1px,transparent_1px),linear-gradient(to_bottom,#ececef_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-40 pointer-events-none" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tight text-zinc-100 mb-2">
            {title}
          </h1>
