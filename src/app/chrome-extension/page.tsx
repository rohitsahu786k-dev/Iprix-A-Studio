        ...
        <div className="container relative z-10">
          <div className="grid gap-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-center mb-20">
            <div>
              ...
              <h1 className="text-5xl lg:text-[64px] font-extrabold tracking-tight text-white mb-6 leading-[1.1]">
          ...
          <div className="grid gap-6 md:grid-cols-3 mb-16">
            ...
            <article className="rounded-3xl border border-zinc-900 bg-zinc-900/30 p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 hover:border-zinc-800 transition-all duration-300 flex flex-col justify-between relative overflow-hidden group">
              <div>
                ...
                <h3 className="font-extrabold text-white text-lg leading-tight mb-2">Meesho Integration</h3>
            ...
            <article className="rounded-3xl border border-zinc-900 bg-zinc-900/30 p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 hover:border-zinc-800 transition-all duration-300 flex flex-col justify-between relative overflow-hidden group">
              <div>
                ...
                <h3 className="font-extrabold text-white text-lg leading-tight mb-2">Flipkart Integration</h3>
                <p className="text-xs text-zinc-400 leading-relaxed mb-6">
            ...
            <article className="rounded-3xl border border-zinc-900 bg-zinc-900/30 p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 hover:border-zinc-800 transition-all duration-300 flex flex-col justify-between relative overflow-hidden group">
              <div>
                ...
                <h3 className="font-extrabold text-white text-lg leading-tight mb-2">Amazon Integration</h3>
                <p className="text-xs text-zinc-400 leading-relaxed mb-6">
          ...
          <div className="rounded-3xl border border-zinc-900 bg-zinc-900/30 p-8 shadow-sm">
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <h4 className="font-bold text-white text-sm mb-1">100% Secure</h4>
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <h4 className="font-bold text-white text-sm mb-1">Privacy First</h4>
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <h4 className="font-bold text-white text-sm mb-1">High Performance</h4>
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <h4 className="font-bold text-white text-sm mb-1">Activity Logs</h4>
